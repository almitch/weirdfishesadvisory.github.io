    ...
    <div class="hero-visual">
      <svg class="hero-dashboard" viewBox="0 0 580 380" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img">
        ...
        <g clip-path="url(#panel-clip)">
          ...
          <text x="24" y="104" fill="white" font-size="28" font-weight="700" font-family="sans-serif" class="kpi-count" data-to="23">23</text>
          ...
          <text x="206" y="104" fill="white" font-size="28" font-weight="700" font-family="sans-serif" class="kpi-count" data-to="1.2" data-decimals="1" data-suffix="M">1.2M</text>
          ...
          <text x="388" y="104" fill="white" font-size="28" font-weight="700" font-family="sans-serif" class="kpi-count" data-to="847">847</text>
